...
document.write('<div class="grid-x grid-margin-x">');
document.write('<table id="fc" style="width:20%;position:absolute;border-collapse:collapse;background:#FFFFFF;border:1px solid #FFD088;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding="2">');
...
//	getObj('fc').style.top=Top(ielem)+ielem.offsetHeight+'px';
	getObj('fc').style.top=Top(ielem)+ielem.offsetHeight-88+'px';
